...
License -> https://github.com/CodeWithNeo/Instasaver/blob/main/LICENSE
```
...
### Deploy to Heroku
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/CodeWithNeo/Instasaver)

Watch This [Video](https://youtu.be/p6kX1lQlIWw) Tutorial For Better Understanding.

While Deploying fill `INSTA_SESSIONFILE_ID`, either by running [generate_instagram_session.py](https://github.com/CodeWithNeo/Instasaver/blob/main/generate_instagram_session.py]) in terminal or using /login after deploy or use [repl.it](https://replit.com/@subinps/generateInstagramSession)
...
```sh
git clone https://github.com/CodeWithNeo/Instasaver
cd Instagram-Bot
...
* `INSTA_SESSIONFILE_ID` Your Instagram session file ID. Generate either by running [generate_instagram_session.py](https://github.com/CodeWithNeo/Instasaver/blob/main/generate_instagram_session.py]) in terminal or using /login after deploy or use [repl.it](https://replit.com/@subinps/generateInstagramSession)
...
Connect Me On [Telegram](https://telegram.dog/ModstoreIran)
